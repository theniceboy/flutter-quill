...
mixin RawEditorStateTextInputClientMixin on EditorState implements TextInputClient {
  ...
  bool get shouldCreateInputConnection => kIsWeb || !widget.configurations.readOnly;
    ...
    if (!hasConnection) {
      ...
      _textInputConnection = TextInput.attach(
        ...
        TextInputConfiguration(
          ...
          allowedMimeTypes: widget.configurations.contentInsertionConfiguration == null
              ? const <String>[]
              : widget.configurations.contentInsertionConfiguration!.allowedMimeTypes,
        ),
      );
