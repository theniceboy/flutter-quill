...
class EditableTextBlock extends StatelessWidget {
  ...
  BoxDecoration? _getDecorationForBlock(
    ...
    return resolveBlockDecoration(block, defaultStyles, textDirection);
  }
  ...
  Widget? _buildLeading({
    ...
    final defaultStyles = QuillStyles.getStyles(context, false)!;
    final spec = resolveLeading(line, defaultStyles, index, count);
    if (spec == null) {
      return null;
    }
    final isCheck = spec.kind == LeadingKind.checkbox;
    ...
    return switch (spec.kind) {
      LeadingKind.number => numberPointLeading(leadingConfig),
      LeadingKind.bullet => bulletPointLeading(leadingConfig),
      LeadingKind.checkbox => checkboxLeading(leadingConfig),
      LeadingKind.codeLineNumber => codeBlockLineNumberLeading(leadingConfig),
    };
  }
  ...
  VerticalSpacing _getSpacingForLine(
    ...
    return resolveSpacingForLine(block, index, count, defaultStyles);
  }
}
